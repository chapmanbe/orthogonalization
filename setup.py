...
setup(
    ...
    description='orthogonalization team project',
    long_description=long_description,

    # The project's main homepage.
    url='https://github.com/chapmanbe/orthogonalization/',

    # Author details
    author='Jason Lloyd, Erik Forsman, Pretty',
    ...
    keywords='Linear Algebra, Debugging, Informatics, Team',
